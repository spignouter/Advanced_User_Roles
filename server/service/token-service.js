...
// генерирует два токена, токен доступа и токен рефреша
class TokenService{
    ...
    // волидация токена доступа, убедиться что он не потделан и что у него срок годности не иссяк
    ...
    // волидация токена рефреша, убедиться что он не потделан и что у него срок годности не иссяк
    ...
    async saveToken(userId, refreshToken){
        ...
        // findOne метод который находит в данные в коллекции
